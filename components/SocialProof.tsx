...
const testimonials = [
  ...
  },
  {
    ...
    title: "Product Safety & Compliance Leader",
  }
];
    ...
    <section id="social-proof" className="py-20 bg-rtpm-blue-800 text-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
           <img src="https://raw.githubusercontent.com/MRHenninh/RTPM-landing/main/RTPMwhiteRTPMlogo.svg" alt="RTPM Logo" className="mx-auto h-16 w-auto" />
           <h2 className="text-4xl font-bold mt-6">This Is Why RTPM Exists</h2>
        </div>
        
        <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl p-8 md:p-12 shadow-2xl mb-20">
          <div className="flex flex-col md:flex-row items-center text-center md:text-left gap-8">
            <img 
              src="https://raw.githubusercontent.com/MRHenninh/RTPM-landing/main/secta.ai_006.jpg" 
