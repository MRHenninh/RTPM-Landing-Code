  ...
  return (
    <section className="bg-gradient-to-br from-rtpm-blue-700 to-rtpm-blue-800 text-white pt-16 pb-20">
      <div className="container mx-auto px-6 text-center">
        <div className="mb-12">
          <img src="https://raw.githubusercontent.com/MRHenninh/RTPM-landing/main/RTPMwhiteRTPMlogo.svg" alt="RTPM Logo" className="mx-auto h-20 w-auto" />
        </div>
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 max-w-4xl mx-auto">
