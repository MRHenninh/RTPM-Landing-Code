    ...
    <section className="bg-gradient-to-br from-rtpm-blue-700 to-rtpm-blue-800 text-white pt-16 pb-20">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-sm md:text-base font-semibold uppercase tracking-wider text-white/80 mb-4">
            For Leaders in Construction, Defense & Energy Projects
        </p>
        ...
        <div className="mb-12">
          <a href="#contact" className="bg-white text-rtpm-blue-700 font-bold text-lg px-10 py-4 rounded-full shadow-lg hover:bg-gray-200 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out inline-block">
            Book a Live Demo
          </a>
        </div>
...
<div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-lg rounded-2xl p-2.5 shadow-2xl">
        <div className="aspect-video"> 
            <iframe 
                src="https://www.youtube.com/embed/5LIsXOU-HWI" 
