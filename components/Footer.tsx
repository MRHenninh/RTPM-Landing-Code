        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-4">
            ...
            <p className="text-gray-600 text-sm">
              ...
              © {new Date().getFullYear()} Real Time Project Management. All rights reserved.
            </p>
          </div>
          <div className="flex items-center gap-6">
            <a href="https://www.linkedin.com/company/real-time-project-management/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition-opacity">
              <img src="https://raw.githubusercontent.com/MRHenninh/RTPM-landing/main/LI-In-Bug.png" alt="LinkedIn" className="w-6 h-6" />
            </a>
            ...
            <span className="bg-rtpm-blue-700 text-white text-xs font-bold px-3 py-1 rounded-full">Microsoft Partner</span>
          </div>
        </div>
      </div>
    </footer>
